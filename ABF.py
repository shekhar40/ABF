...
logo = ''' 
\033[0;96m╔══════════════════════════════════════════════════╗
\033[0;96m║ \033[1;93m   ___    ___    ____   \033[0;91m| Github.com/\033[0;91mChangFB     \033[0;96m║
\033[0;96m║ \033[1;93m  / _ |  / _ )  / __/ \033[0;96m® \033[0;91m| Created By \033[0;91mChangFB     \033[0;96m║
\033[0;96m║ \033[1;93m / __ | / _  | / _/     \033[0;91m| Facebook.com/\033[0;91mChangFB   \033[0;96m║
\033[0;96m║ \033[1;93m/_/ |_|/____/ /_/\033[1;93m(︶.︶メ)\033[0mVISI MISI FOYA FOYA\033[1;93mV2.0\033[0;96m║
\033[0;96m╚══════════════════════════════════════════════════╝'''
...
def yayanxd():
    ...
    try:
        ...
        print '%s╠══[%s Subscribe Channel DJ MUSIC JR7 Dulu Ya:v \033[0;96m]'%(O,N);time.sleep(2)
...
def info_tools():
    ...
    print '%s[%s>%s] Yt       : DJ MUSIC JR7 (Orang Ganteng Hehe)'%(N,H,N);time.sleep(0.09)
    print '%s[%s>%s] Author   : ChangFB.'%(N,H,N);time.sleep(0.09)
    print '%s[%s>%s] Github   : https://github.com/ChangFB'%(N,H,N);time.sleep(0.09)
    print '%s[%s>%s] Facebook : https://www.facebook.com/ChangFB'%(N,H,N);time.sleep(0.09)
    print '%s[%s>%s] Instagram: https://www.instagram.com/DJMUSICJR7'%(N,H,N);time.sleep(0.09)
    print '%s[%s#%s]'%(N,O,N), 52 * '\x1b[1;96m-\x1b[0m';time.sleep(0.09)
    print '%s[%s>%s] TEAM PROJECT HAECKER-FB 2022'%(N,H,N);time.sleep(0.09)
    print '%s[%s#%s]'%(N,O,N), 52 * '\x1b[1;96m-\x1b[0m';time.sleep(0.09)
    print '%s[%s>%s] • HaeckFB (CrackFB)'%(N,H,N);time.sleep(0.09)
    print '%s[%s>%s] • HaeckerFB'%(N,H,N);time.sleep(0.09)
    print '%s[%s>%s] • Changcuters'%(N,H,N);time.sleep(0.09)
    print '%s[%s>%s] • Termux-FB'%(N,H,N);time.sleep(0.09)
    print '%s[%s>%s] • Nunungfb25 (Chang-FB)'%(N,H,N);time.sleep(0.09)
    print '%s[%s#%s]'%(N,O,N), 52 * '\x1b[1;96m-\x1b[0m';time.sleep(0.09)
